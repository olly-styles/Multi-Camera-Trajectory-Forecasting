...
for fold in range(1, 6):
    ...
    train_loader = datasets.get_hand_crafted_classification_dataset(**train_dataset_args)
    val_loader = datasets.get_hand_crafted_classification_dataset(**val_dataset_args)
    test_loader = datasets.get_hand_crafted_classification_dataset(**test_dataset_args)

    # ########## SET UP MODEL ########## #
    model = models.LinearClassifier(**network_args).to(DEVICE)
